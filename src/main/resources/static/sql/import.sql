...
INSERT INTO game(genre, description, year, name, company_id) VALUES
  (0, 'Dota 2 — компьютерная многопользовательская командная игра в жанре multiplayer online battle arena, разработанная Valve Corporation.', 1998, 'Dota2', 9),
  ...
  (3, 'Call of Duty: Black Ops 4 — компьютерная игра в жанре шутера от первого лица, пятнадцатая во франшизе Call of Duty и пятая основная игра в сюжетной подсерии Black Ops, начинавшаяся как продолжение Call of Duty: Black Ops 3. Выход игры состоялся 12 октября 2018 года.', 2018, 'Call of Duty: Black Ops 4', 9),
